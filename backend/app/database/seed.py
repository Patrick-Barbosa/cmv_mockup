...
async def seed_db(session):
    """Insere dados de exemplo reais para teste e desenvolvimento."""
    ...
    for _ in range(6): # Múltiplos passes para resolver dependências de receitas compostas
    ...
    await session.commit()
    print("[seed_db] Seed data inserted successfully.")
