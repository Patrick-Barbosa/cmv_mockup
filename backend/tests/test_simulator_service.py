...
class TestProductInfoEndpoint:
    def test_returns_custo_for_insumo(self):
        ...
        session.get = AsyncMock(return_value=mock_produto)
        mock_res = MagicMock()
        mock_res.scalar = MagicMock(return_value=None)
    ...
    def test_returns_null_custo_for_receita(self):
        ...
        assert result.custo_atual == 1.50
        assert result.unidade_medida == "kg"
...
class TestSimulatorPriceChangeLogic:
    ...
    def test_simulate_price_change_impact_sign(self):
        ...
        async def run_test():
            ...
            return await service._simulate_price_change(input_data, "2026-05", "current_and_partial")
    ...
    def test_simulate_recipe_change_price_increase_with_components(self):
        ...
        async def run_test():
            ...
            return await service._simulate_recipe_change(input_data, "2026-05", "current_and_partial")
        ...
        assert result.change_applied == "Nova formulacao"